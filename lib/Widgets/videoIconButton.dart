...
// ignore: deprecated_member_use
                        ...
                        if (picked != null) {
                          if (picked != null) {
                            ...
                            print('$vedioUrl');
                            BlocProvider.of<GetFireDataCubit>(context).emit(getVideoState(videoUrl: '$vedioUrl'));
                            Get.back();
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.camera_alt,color: Colors.teal,size: 27,),
                          Text(
                            '   from camera',
                            style: TextStyle(
                                fontSize: 17,
...
// ignore: deprecated_member_use
                      ...
                      child: Row(
                        children: [Icon(Icons.image,color: Colors.blue,size: 27,), Text('   from gallery',
                          style: TextStyle(
                              fontSize: 17,
                              fontWeight: FontWeight.w500,
                              color: Colors.white),)],
